...
class WeekView<T extends Object?> extends StatefulWidget {
  ...
  /// First hour displayed in the layout, goes from 0 to 24 Cannot be smaller than [startHour]
  final int? endHour;
  ...
  const WeekView({
    ...
    this.endHour,
        ...
        assert(
          ...
          "startHour must be smaller than endHour",
        ),
        super(key: key);
...
class WeekViewState<T extends Object?> extends State<WeekView<T>> {
  ...
  Widget _defaultPressDetectorBuilder({
    ...
    final slots = ((_endHour - _startHour) * 60) ~/ minuteSlotSize.minutes;
