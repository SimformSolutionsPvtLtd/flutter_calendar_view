...
class MergeEventArranger<T extends Object?> extends EventArranger<T> {
  ...
  List<OrganizedCalendarEventData<T>> arrange({
    ...
    for (final event in events) {
      ...
      if (event.endDate.millisecondsSinceEpoch < event.date.millisecondsSinceEpoch) {
      ...
      eventEnd = math.min(Constants.minutesADay - (startHour * 60), eventEnd);
      ...
      if (eventIndex == -1) {
        ...
        final visibleMinutes = Constants.minutesADay - (startHour * 60);
